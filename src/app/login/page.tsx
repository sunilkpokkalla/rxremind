...
function LoginForm() {
  ...
  const handleQuickDemoClick = (e: React.MouseEvent) => {
    setEmailInput('owner@rxremind-demo.com');
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white z-10 shadow-xl">
        <div className="mx-auto w-full max-w-md">
          ...
          <p className="mt-2.5 text-sm text-slate-500">
            Or{' '}
            <Link href="/signup" className="font-semibold text-primary hover:text-primary-hover transition">
          ...
          <div className="mt-6 p-4 bg-primary-light/50 border border-primary/10 rounded-2xl shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-primary-dark">Want a quick walkthrough?</h4>
                <p className="text-xs text-slate-600 mt-1 leading-normal">
                  Click below to pre-fill the demo clinic credentials. You will instantly log in with full pre-seeded patient lists and simulated message logs!
                </p>
                <button
                  type="button"
              ...
              >
                {isLoading ? (
                  <span className="flex items-center space-x-2">
                    ...
                    <span>Authenticating Clinic...</span>
                  </span>
                ) : (
                  <>
                    <span>Login to Clinic</span>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-white/10">
              ...
              <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <div className="flex items-center space-x-2 text-primary-light">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider font-sans">Reach</span>
                </div>
