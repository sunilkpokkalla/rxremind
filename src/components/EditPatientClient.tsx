  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="border-b border-slate-100 pb-4">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight mt-0.5">Edit Patient Profile</h1>
        <p className="text-sm text-slate-500 mt-1">
          Modify patient parameters, scheduling intervals, or update their current confirmation status.
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-8">
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    defaultValue={patient.medication_name}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    min="1"
                    defaultValue={patient.refill_frequency_days}
                    className="block w-full pl-9 pr-3 py-2.5 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition"
                    placeholder="30"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="date"
                    required
                    defaultValue={patient.next_refill_date}
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  required
                  defaultValue={patient.reminder_channel}
              ...
              <div className="space-y-1.5">
                <label htmlFor="status" className="block text-xs font-bold text-slate-700">
                  Refill Status Override <span className="text-danger">*</span>
                </label>
                <select
                  id="status"
                  name="status"
                  ...
                  className="block w-full border border-slate-200 rounded-xl px-3 py-2.5 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition"
                >
                  <option value="confirmed">Confirmed (Refilled)</option>
                  <option value="pending">Pending Response</option>
                  <option value="overdue">Overdue for Refill</option>
                </select>
              </div>
            </div>
          </div>
          ...
          {/* Action Buttons */}
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-t-slate-100">
            <Link
              href="/patients"
